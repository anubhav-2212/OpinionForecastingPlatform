...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f2e7] px-5 py-10">
      <div className="absolute inset-x-0 top-0 -z-10 h-[28rem] bg-[radial-gradient(circle_at_top,_rgba(42,157,143,0.18),_transparent_35%),linear-gradient(180deg,_#f8f2e7_0%,_#f4ead8_100%)]" />
