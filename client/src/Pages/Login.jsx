...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#edf6f7] px-5 py-10">
      <div className="absolute inset-x-0 top-0 -z-10 h-[28rem] bg-[radial-gradient(circle_at_top,_rgba(42,157,143,0.18),_transparent_35%),linear-gradient(180deg,_#edf6f7_0%,_#dfeef2_100%)]" />
      ...
      <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#e3d6c6] bg-[#fffaf2]/85 p-4 shadow-2xl shadow-[#ddc5a7]/40 backdrop-blur sm:p-6 lg:grid lg:grid-cols-[0.95fr_1.05fr] lg:gap-6">
        <div className="rounded-[1.75rem] bg-[linear-gradient(135deg,_#1f5c4d_0%,_#2a9d8f_58%,_#f7d27b_100%)] p-8 text-white">
        ...
        <div className="p-4 sm:p-8">
          ...
          <h2 className="mt-8 text-3xl font-semibold tracking-tight text-[#183229]">Log in</h2>
          <p className="mt-2 text-sm text-[#6f7c74]">
            No account yet?{" "}
            <Link to="/signin" className="font-medium text-[#183229] underline decoration-[#e76f51] underline-offset-4">
              Create one
            </Link>
          </p>
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-[#d9cbb6] bg-[#fffdf8] px-4 py-3 pr-12 outline-none transition focus:border-[#2a9d8f]"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-2xl bg-[#e76f51] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#cf5c40] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500"
            >
